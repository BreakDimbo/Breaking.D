<%@ page language="java" import="com.limbo.shopping.model.Product" pageEncoding="utf-8" %>
...
<%
    ...
    int totalRecords = ProductMgr.getInstance().getProducts(products, pageNo, PAGE_SIZE, 1);
...
<center><a href="ProductAdd.jsp" target="_self">添加新产品</a></center>
                    ...
                    <td>
                        <table class="tableborder" cellpadding="2" cellspacing="1">
                            ...
                            <tr class="smalltxt" bgcolor="#f3f6fa">
                                ...
                                %>
                                <td>&nbsp;
                                    <a href="ProductList.jsp?pageNo=<%=i%>"><%=i%>
                                    </a>&nbsp;
                                </td>
                                <%
                                        }
    ...
    <table class="tableborder" align="center" cellpadding="4"
        ...
        <tr>
            ...
            <td class="altbg1" align="right">
                <a target="detail" href="ProductDelete.jsp?id=<%=p.getId()%>" onclick="return confirm('真的要删?')">删除</a>
                <a target="_blank" href="ProductModify.jsp?id=<%=p.getId()%>">修改</a>
                <a target="_blank" href="ProductUpload.jsp?id=<%=p.getId()%>">上传图片</a>
            </td>
        </tr>
