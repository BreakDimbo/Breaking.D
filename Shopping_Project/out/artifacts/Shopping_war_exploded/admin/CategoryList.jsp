<%@ page language="java" import="com.limbo.shopping.model.Category" pageEncoding="GB18030" %>
...
<center><a href="CategoryAdd.jsp">添加类别</a></center>
...
<table class="tableborder" align="center" cellpadding="4"
    ...
    <tr>
        ...
        <td class="altbg2" align="right">
            ...
            <a href="CategoryDelete.jsp?id=<%=c.getId()%>&pid=<%=c.getPid()%>">删除类别</a>
