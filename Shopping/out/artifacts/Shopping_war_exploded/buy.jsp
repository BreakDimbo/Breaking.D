<%@ page language="java" import="com.limbo.shopping.model.Cart" pageEncoding="utf-8" %>
<%@ page import="com.limbo.shopping.model.CartItem" %>
...
<form action="buy.jsp" method="get">
    ...
    <table align="center" border="1">
        ...
        <tr>
            ...
            <td><%=ci.getProduct().getNormalPrice() %>
            </td>
            <td><%=ci.getProduct().getNormalPrice() * ci.getCount() %>
            </td>
            <td>
